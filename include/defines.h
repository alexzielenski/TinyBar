...
#define DEFAULT_PREFS [NSDictionary dictionaryWithObjectsAndKeys: @DEFAULT_SCROLLTOEND, PREFS_SCROLLTOEND_KEY, @DEFAULT_STRETCH_BANNER, PREFS_STRETCH_BANNER_KEY, @DEFAULT_SHOWICON, PREFS_SHOWICON_KEY, @DEFAULT_DURATION_LONG, PREFS_DURATION_LONG_KEY, @DEFAULT_SHOWTITLE, PREFS_SHOWTITLE_KEY, @DEFAULT_DURATION, PREFS_DURATION_KEY, @DEFAULT_SPEED, PREFS_SPEED_KEY, @DEFAULT_HEIGHT, PREFS_HEIGHT_KEY, @DEFAULT_ENABLED, PREFS_HEIGHT_KEY, nil]